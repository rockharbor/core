...
$changes = array_diff_assoc($revision['Revision'], $involvement['Involvement']);
$changes = Set::filter($changes);
?>
<p>The following changes have been requested for <strong><?php echo $involvement['Involvement']['name']; ?></strong> on <strong><?php echo $this->Formatting->date($version_created); ?></strong></p>
...
<p>There are no revisions to <?php echo $involvement['Involvement']['name']; ?>.</p>
