...
<div class="alerts index">
	...
	<div class="box core-iconable">
		<?php
		echo $this->Html->tag('strong', $this->Html->link($alert['Alert']['name'], array('action' => 'view', $alert['Alert']['id']), array('data-core-modal' => '{"update":false}')));
		echo '<br />';
		...
		<div class="core-icon-container">
			...
			echo $this->Html->link($icon, array('action' => 'edit', $alert['Alert']['id']), array('data-core-modal' => 'true', 'escape' => false, 'class' => 'no-hover'));
...
<ul class="core-admin-tabs">
	<li><?php echo $this->Permission->link('New Alert', array('action' => 'add'), array('data-core-modal' => 'true')); ?></li>
</ul>