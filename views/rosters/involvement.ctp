			...
			<tbody>
				...
				<tr>
					...
					if (!empty($roster['Roster']) && $roster['Roster'][0]['balance'] > 0) {
						...
						$link = $this->Html->link($due, array('controller' => 'payments', 'action' => 'add', 'Involvement' => $roster['Involvement']['id'], $roster['Roster'][0]['id'], 'User' => $roster['Roster'][0]['user_id']), array('data-core-modal' => 'true', 'class' => 'balance'));
