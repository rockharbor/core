 ...
 */
	Configure::write('Security.salt', 'NOhG9K234Naowl74LapWguVoUubWwvniR434NAdf90MWmi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '2348930965748563212496748642645');
	
/**
 * The old CORE password encryption key
 */
	Configure::write('Security.encryptKey', '8M81T1Q3d6LC8h');
